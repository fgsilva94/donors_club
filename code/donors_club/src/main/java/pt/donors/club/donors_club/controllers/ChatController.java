...
public class ChatController {
  ...
  public Iterable<Chat> getChats(@PathVariable int userId) {
  ...
  public Chat initChat(@RequestBody Chat chat) {
    ...
    Optional<Chat> _chat = chatRepository.findChatByAdPostAndUser(chat.getUser().getId(), chat.getOwner().getId());
